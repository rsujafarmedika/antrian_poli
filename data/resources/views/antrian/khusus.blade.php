...
<head>
    ...
    <title>Data Antrian Pasien Khusus Pagi</title>
        ...
        <div class="row">
            <div class="col">
                <div class="card footer text-dark mt-2">
                    <div class="row">
                        <div class="col-md-10">
                            <h4 class="card-title text-center">Data Antrian Pasien Khusus Pagi</h4>
                        </div>
                        <div class="col-md-2 text-center">
                            <a href="{{ route('antrian') }}" class="btn btn-sm btn-success">Kembali</a>
                        </div>
                    </div>
                </div>
            </div>
