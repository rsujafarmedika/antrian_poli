...
<head>
    ...
    <title>Admin Antrian Akupuntur Sore</title>
                ...
                <div class="card footer text-dark mt-2">
                    <div class="row">
                        <div class="col-md-2 text-center">
                            <a href="{{ route('p_khusus_sore') }}" class="btn btn-sm btn-success">Pasien Khusus</a>
                        </div>
                        <div class="col-md-8">
                            <h4 class="card-title text-center">Admin Antrian Akupuntur Sore</h4>
                        </div>
                        <div class="col-md-2 text-center">
                            <a href="{{ route('p_lewati_sore') }}" class="btn btn-sm btn-success" >Pasien Dilewati</a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-2 text-center">
                            <a href="" class="btn btn-sm btn-success" data-bs-toggle="modal"
                                data-bs-target="#exampleModal">Pasien Khusus</a>
                            <!-- Modal -->
                            <div class="modal fade" id="exampleModal" tabindex="-1"
                                aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content scrollable-container" style="max-height: 500px;overflow-y: auto;">
                                        <div class="modal-header">
                                            <h1 class="modal-title fs-5" id="exampleModalLabel">Data Pasien Khusus
                                            </h1>
                                        </div>
                                        <div class="modal-body">
                                            <table class="table table-bordered">
                                                <form action="{{ route('pp_khusus_sore') }}" method="post">
                                                    {{ csrf_field() }}
                                                    <thead style="background-color: #229258"
                                                    ...
                                                    <tbody>                                                    
                                                        @foreach ($reg as $data)
                                                        <tr>
                                                                <input type="text" name="no_rawat" value="{{ $data->no_rawat }}" style="display: none;">
                                                                <input type="text" name="no_rkm_medis" value="{{ $data->no_rkm_medis }}" style="display: none;">
                                                                <input type="text" name="nm_pasien" value="{{ $data->nm_pasien }}" style="display: none;">
                                                                <input type="text" name="no_reg" value="{{ $data->no_reg }}" style="display: none;">
                                                                ...
                                                                <td>
                                                                    <select name="bed" class="form-select"
                                                                        ...
                                                                        <option value="0">R. Konsultasi</option>
                                                                    </select>
                                                                </td>
                        ...
                        <div class="col-md-8">
                            <h6 class="card-title text-center">Admin Antrian Akupuntur Sore</h6>
                        </div>
                        <div class="col-md-2 text-center">
                            <a href="" class="btn btn-sm btn-success" data-bs-toggle="modal"
                                data-bs-target="#exampleModal">Pasien Dilewati</a>
                            <!-- Modal -->
                            <div class="modal fade" id="exampleModal" tabindex="-1"
                                aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h1 class="modal-title fs-5" id="exampleModalLabel">Data Pasien Dilewati
                                            </h1>
                                        </div>
                                        <div class="modal-body">
                                            <table class="table table-bordered">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <select class="form-select"
                                                                    aria-label="Default select example">
                                                                    <option value="1">BED 1</option>
                                                                    <option value="1">BED 2</option>
                                                                    <option value="1">BED 3</option>
                                                                    <option value="1">BED 4</option>
                                                                    <option value="1">BED 5</option>
                                                                </select>
                                                            </td>
                                                            <td class="text-center">
                                                                <a href=""
                                                                    class="btn btn-sm btn-primary">PANGGIL</a>
                                                            </td>
                                                        </tr>
                                                    @endforeach
                                                </tbody>
