        ...
        <div class="row">
            <div class="col">
                <div class="card footer text-dark mt-2">
                    <div class="row">
                        <div class="col-md-10">
                            <h4 class="card-title text-center">Data Antrian Akupuntur Sore Dilewati</h4>
                        </div>
