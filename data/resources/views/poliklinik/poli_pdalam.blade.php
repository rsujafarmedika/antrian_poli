...
<head>
    ...
    <title>Admin Antrian Poliklinik Penyakit Dalam</title>
            ...
            <div class="col">
                <div class="card footer text-dark mt-2">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <h4 class="card-title text-center">Admin Antrian Poliklinik Penyakit Dalam</h4>
                        </div>
                        <div class="col-md-2 text-center">
