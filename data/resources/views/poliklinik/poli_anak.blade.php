...
<head>
    ...
    <title>Admin Antrian Poliklinik Anak</title>
            ...
            <div class="col">
                <div class="card footer text-dark mt-2">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <h4 class="card-title text-center">Admin Antrian Poliklinik Anak</h4>
                        </div>
                        <div class="col-md-2 text-center">
                                    ...
                                    @foreach ($anak as $no => $data)
                                        <tr>
                                            ...
                                            <td>
                                                <ul>
                                                    <li>
                                                        <input type="text" id="inputText1" value="pasien nomer antrian , silahkan ke poli anak" style="display: none">
